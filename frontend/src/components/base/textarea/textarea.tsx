...
export const TextAreaBase = ({ className, size = "md", ...props }: TextAreaBaseProps) => {
    return (
        <AriaTextArea
            ...
            className={(state) =>
                cx(
                    "w-full scroll-py-3 rounded-lg bg-white text-gray-900 shadow-xs ring-1 ring-gray-300 transition duration-100 ease-linear ring-inset placeholder:text-placeholder autofill:rounded-lg autofill:text-gray-900 focus:outline-hidden",
                    ...
                    state.isFocused && !state.isDisabled && "ring-2 ring-primary",
